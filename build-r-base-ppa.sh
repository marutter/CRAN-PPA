...
then
    sed -i '/^Build-Depends/s/tk8.5-dev/tk-dev/' debian/control
    sed -i '/^Build-Depends/s/tcl8.5-dev/tcl-dev/' debian/control
    dch -a "debian/control Changed dependency to generic tcl-dev and tk-dev for Raring"
